...
myPenguin = {
  ...
  sayHello: function() {
    return "\nHola, soy un pingüino y mi nombre es " + this.character + "\n";
  }
};
...
myPenguin.squawk = () => "kaww kaww!!";

console.log("/********************************/", "\n");
console.log(myPenguin);
console.log("\n");
console.log("Y asi grazno -->", myPenguin.squawk());
console.log("\n");
console.log("/********************************/", "\n");
...
myPenguin.canFlyMethod = canFly =>
  canFly ? "¡Puedo volar!" : "No puedo volar :(";
console.log(myPenguin.canFlyMethod(true));
// -----------------------------------------------------------------------
...
console.log(myPenguin.canFlyMethod(myPenguin.canFly));
// -------------------------------------------------------------
...
class Book {
  constructor(title, author, isComplete) {
    this.title = title;
    this.author = author;
...
arrayBooks = [
  new Book("100 años", "Gabriel Garcia", false),
  new Book("davinci code", "dawn brown", true)
];
